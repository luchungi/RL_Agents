...
class DDPG_Agent:
    ...
    def __init__(self, num_actions, obs_size,
        ...
        if critic:
            ...
            self.critic = Critic(self.obs_size + num_actions, activation=activation)
    ...
    def train_critic(self, current_states, actions, rewards, next_states, not_terminal):
        ...
        with torch.no_grad():
            if self.next_state_action:
                ...
                # else: b = 0.
                # q = self.target_critic(torch.cat([current_states, actions], dim=-1))[0]
    ...
    def train_actor(self, current_states):
        ...
        q_values = self.critic(torch.cat([current_states, actions], dim=-1))[0]
