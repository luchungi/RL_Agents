...
class PPO_RG_Agent:
    ...
    def train_batch(self, current_states, actions, old_log_probs, advantages, returns):
        ...
        # MAIN DIFFERENCE OF RG VERSION:GRADIENT INCLUDES ONE MORE ADVANTAGE TERM WHICH IS GRADIENT OF REWARD FUNCTION
        actor_loss  = -(torch.min(surr1, surr2) + advantages).mean()
